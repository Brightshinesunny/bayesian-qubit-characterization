...
## 01_zenodo_baseline — Foundational Pipeline (8/21–8/23)
...
## 02_fano_resonator — Fano Resonators, Circle Fit vs. Bayesian/Fisher (8/23–8/27)
...
## 03_avoided_crossing_tls — Avoided-Crossing Revisited + TLS Extension (8/28)
...
## 04_tls_data_structure — Decoding the TLS Data Structure (8/27)
...
## 05_tls_noise_diagnosis_dip_tracking — Systematic-Error Diagnosis + Dip Tracking (8/27)
...
## 06_tls_multi_file_integration — Combining Three TLS Files (8/29)
...
## 07_catalog_to_raw_mapping — Catalog↔Raw Reverse Mapping (8/29)
...
## 08_validation_robots — Validation Robots (8/28–8/29)

Eight robots (prior sanity check / parameter recovery / multi-start
...
(notably, the quality-score robot's failure to distinguish "global"
...
2. **Reusable code**: `08_validation_robots/tls_avcross_pipeline.py` (avoided-crossing),
   `08_validation_robots/validation_robots.py` (validation),
