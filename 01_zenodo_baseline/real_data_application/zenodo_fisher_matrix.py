"""
zenodo_fisher_matrix.py
=================================================================
피셔 정보 행렬 기반 파라미터 오차 추정. Zenodo 실측 데이터 파이프라인
(zenodo_fit_and_compare.py)에서, MCMC posterior와 나란히 비교하기
위한 모듈입니다.
...
if __name__ == "__main__":
    print("zenodo_fisher_matrix.py 자가진단")
    print("-" * 55)
